...
//        if(maxX()-minX()<=5&&(maxX()!=0||minX()!=0)){
//
//            xMin=minX()-(10.0*(maxX()-minX()))/100.0;
//            xMax=maxX()+(10.0*(maxX()-minX()))/100.0;
//            yMin=minY()-(10.0*(maxY()-minY()))/100.0;
//            yMax=maxY()+(10.0*(maxY()-minY()))/100.0;
//        }else {
//            xMin = minX() - deltaX;
//            xMax = maxX() + deltaX;
//            yMin = minY() - deltaY;
...
//        }
        ...
        //Опред коэф преобраз-я и полож-я начала коорд
...
class DataSheetGraphBeenInfo extends SimpleBeanInfo {
    private PropertyDescriptor[] propertyDescriptors;

    public DataSheetGraphBeenInfo(){
        try {
