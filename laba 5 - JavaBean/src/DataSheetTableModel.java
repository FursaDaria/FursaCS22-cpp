...
public class DataSheetTableModel extends AbstractTableModel {
            ...
            if (dataSheet != null) {
                switch (columnIndex) {
                    case 0:
                        ...
                        break;
                    case 1:
                        dataSheet.setX(Double.valueOf((String) aValue), rowIndex);
                        fireDataSheetChange();
                        break;
                    case 2:
                        dataSheet.setY(Double.valueOf((String) aValue), rowIndex);
                        fireDataSheetChange();
                        break;
                }
            }
    ...
    protected void fireDataSheetChange(){
        Iterator<DataSheetChangeListener> i=listeners.iterator();
        while (i.hasNext()) {
